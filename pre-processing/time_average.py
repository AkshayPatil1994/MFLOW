...
start_exp_num = 2                                   # Starting experiment number   
end_exp_num = 50                                    # Ending experiment number   
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # #
# SIMPLE PROGRESS BAR FUNCTION  - Alternative to tqdm #
# # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
#
for e_num in range(start_exp_num, end_exp_num + 1):
